...
int auto_schedule_false(struct halide_buffer_t *_image_to_blend_f_buffer, struct halide_buffer_t *_target_value_f_buffer, struct halide_buffer_t *_output_buffer);
